{
  ...
  inputs.nixpkgs = { type = "github"; owner = "NixOS"; repo = "nixpkgs"; ref = "nixos-23.05"; };

  # Upstream source tree(s).
  inputs.scion-src = { type = "github"; owner = "scionproto"; repo = "scion"; ref = "master"; flake = false; };

  inputs.scion-apps-src = { type = "github"; owner = "sarcasticadmin"; repo = "scion-apps"; ref = "cf4ba539a3f94af0c30dec0d50a5d0a1a0ff0f09"; flake = false; };
    ...
    in
    {
      ...
      overlay = final: prev: with final.pkgs; {
        ...
        scion = buildGoModule {
          ...
          src = scion-src;
          vendorSha256 = "sha256-GuJEpBUvJS5SG380+P/81cMGxZDVsySyRWa/iVlvlrg=";
        ...
        scion-apps = buildGo119Module {
          ...
          '';
          buildInputs = [ openpam ];
          vendorSha256 = "sha256-2wag7wRysPS0kesLUXVs+khYy0pTw2bwOr7bFB3RYOg=";
	  ...
	  buildPhase = ''
        ...
        scion-apps-examples = buildGo119Module {
          pname = "scion-apps-examples";
          version = versions.scion-apps;
          src = scion-apps-src;
          modRoot = "_examples";

          vendorSha256 = "sha256-U2xHesnsaGXjoNSGSlFGHtcEQee4hTlyygRMXWEKgzk=";
        ...
        rains = buildGoModule {
          ...
          src = rains-src;
          vendorSha256 = "sha256-X9qJh9b7D2MPiYRA9vjWlBHsMh7moGt91OOVqX0Qa+k=";
        };
